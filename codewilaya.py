...
df = pd.read_excel("tablewilaya.xlsx")
...
df.to_excel("resultats_GAM_2.xlsx", index=False)

print("✅ SUCCESS : modèle corrigé et exécuté")
print("📁 fichier généré : resultats_GAM.xlsx")
